...
var iframe = $('iframe');
var numTabs = 3;
var default_url = "https://en.wikipedia.org/wiki/Main_Page";

var tabTemplate = '<div class="tab current"><input value="' + default_url + '"/><i class="icon fav-icon' + ' ion-android-globe' + '"></i> <span class="name">' + 'Wikipedia' + '</span><i class="icon ion-android-close"></i></div>';

$(".tabs").append('<div class="tab"><input value="' + 'https://www.android.com/' + '"/><i class="icon fav-icon' + ' ion-social-android' + '"></i> <span class="name">' + 'Android' + '</span><i class="icon ion-android-close"></i></div>'+'<div class="tab"><input value="' + 'https://jquery.com/' + '"/><i class="icon fav-icon ' + 'ion-android-globe' + '"></i> <span class="name">' + 'jQuery' + '</span><i class="icon ion-android-close"></i></div>');
